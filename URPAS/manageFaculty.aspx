<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="manageFaculty.aspx.cs" Inherits="URPAS.WebForm4" %>
        ...
        <div class="form-group col-md-2 ">
            <div class="input-group">
                <asp:TextBox runat="server" TextMode="Email" CssClass="form-control" name="email"
                            ID="TextBox1" placeholder="Email Address" required></asp:TextBox>
